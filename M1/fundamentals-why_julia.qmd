...
Julia is made for scientific computing as shown by the table below which compare some languages in terms
...
<a href="./images/de_solver_software_comparsion.pdf">
  <img class="centering" width="100%" src="./images/de_solver_software_comparsion.png"/>
</a>
...
<a href="./images/jpr-cheatsheet.pdf">
  <img class="centering" width="100%" src="./images/jpr-cheatsheet.png"/>
</a>

One goal of Julia is to be efficient and high-level. This is illustrated by the following figure 
given by [Mandelbrot benchmark project](https://benchmarksgame-team.pages.debian.net/benchmarksgame/description/mandelbrot.html#mandelbrot).

<a href="./images/comparison.png">
  <img class="centering" width="80%" src="./images/comparison-big.png"/>
</a>
